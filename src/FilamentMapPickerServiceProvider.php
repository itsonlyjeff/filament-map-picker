...
class FilamentMapPickerServiceProvider extends PackageServiceProvider
{
    ...
    public static string $viewNamespace = 'filament-map-picker';
    ...
    {
        return 'itsonlyjeff/filament-map-picker';
    }
    ...
    {
        return [
            // AlpineComponent::make('filament-map-picker', __DIR__ . '/../resources/dist/components/filament-map-picker.js'),
